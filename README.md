...
## Data
The dataset contains information about countries, years, regions, income groups, health indicators, and population data from various countries. The original dataset consists of 6 columns and 3,174,996 rows. Columns included in the dataset:
